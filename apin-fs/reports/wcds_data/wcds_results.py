...
def plot_wcds(kwarg_dicts, tp_fp, tn_fn):
    ...
    # save a pdf file
    fig.savefig(
        '/home/nath/springer-fs-paper/LaTeX_DL_468198_240419/images_AI/compare_wcds.pdf')
    # save an eps file
    fig.savefig(
        '/home/nath/springer-fs-paper/LaTeX_DL_468198_240419/images_AI/compare_wcds.pdf')  # eps', format='eps', dpi=800)
    plt.show()
...
if __name__ == '__main__':
    accuracies = {'RF': 92.98245614035088,
    ...
    accuracies_testing = {'RF': 92.98245614035088,
                          'DP': 95.32163742690058,
                          'EN': 95.90643274853801,
                          'L1': 94.15204678362574,
                          'XbC': 88.90643274853801,
                          'OA': 95.32163742690058}
    selected_inputs = {'RF': 8, 'L1': 32,
                       'XbC': 8, 'DP': 32, 'EN': 32, 'OA': 6}
    ...
    df_TP_FP = {
        ...
        'group': ['RF',  'RF', 'L1', 'L1', 'XbC',  'XbC',  'EN', 'EN', 'DP', 'DP', 'OA', 'OA']
    }
    df_TN_FN = {
